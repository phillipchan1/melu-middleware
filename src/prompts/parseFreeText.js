...
Given the rotation summary and aspiration answer below, extract the following signals:

1. staples_cuisines: array of cuisine types explicitly or implicitly mentioned in the rotation. Use standard labels: "Mexican", "Italian", "American", "Asian", "Mediterranean", "Indian", "Middle Eastern", "French", "Greek", "Other". Return [] if none detected.
...
User answers:
Rotation (meals the family already eats): {{staples}}
